...
//	  case 314://PiMaker
//		  {
//			out.println_P(PSTR("polar"));
//			printer_state.usePolar=true;
//			break;
//		  }
//	  case 315: // no PiMaker
//		{
//			out.println_P(PSTR("Cartesian"));
...
//#endif
    ...
    switch( com->M ) {
      ...
      case 111:
        ...
        break;
      case 115: // M115
        out.println_P(PSTR("FIRMWARE_NAME:PiMaker_" REPETIER_VERSION " FIRMWARE_URL:http://PiMaker.com/Firmware/ PROTOCOL_VERSION:1.0 MACHINE_TYPE:PiMaker EXTRUDER_COUNT:1 PIMAKER_PROTOCOL:1"));
        break;
      case 114: // M114
        printPosition();
        break;
