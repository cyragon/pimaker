...
*/
/**
\mainpage PiMaker-Firmware for Arduino based RepRaps
...
- M250 Use Polar Coordniates
- M251 Turn off Polar Coordnites
*/
...
#endif
#if X_MIN_PIN>-1
   if((cur->dir & 68)==64) if(READ(X_MIN_PIN) != ENDSTOP_Z_MIN_INVERTING) {cur->dir&=~64;}
#endif
#if X_MAX_PIN>-1
   if((cur->dir & 68)==68) if(READ(X_MAX_PIN)!= ENDSTOP_Z_MAX_INVERTING) {cur->dir&=~64;}
#endif
  }
