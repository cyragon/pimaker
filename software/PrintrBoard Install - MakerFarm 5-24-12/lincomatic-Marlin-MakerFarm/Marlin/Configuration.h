...
#define PREVENT_DANGEROUS_EXTRUDE false
...
#define Z_MTR_STPS 400      		// Enter number of steps per one revolution of the Z motor(s).
...
#define BELT_PITCH 5.08				// Enter pitch of X and Y belts in millimeters (space from tooth to tooth). XL belts = 5.08mm
#define GEAR_TEETH 10				// Enter number of teeth on X and Y gears
#define Z_ROD_PITCH	1.411111111111111			// Enter pitch of Z rods in millimeters. Pitch = 1.25mm for directly driven M8 rods.
