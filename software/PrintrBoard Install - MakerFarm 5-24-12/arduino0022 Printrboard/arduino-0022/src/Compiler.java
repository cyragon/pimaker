  ...
  List<File> coreObjectFiles =
   ...
   for(File file : coreObjectFiles) {
    ...
    if (elfAddCommand != null) {
      String scriptBasePath = avrBasePath;
      if (Base.isLinux()) scriptBasePath = "hardware/tools/";
...
//    }
  ...
  static private void serial_number_define(List cmd, Map<String, String> boardPrefs) {
    if (boardPrefs.get("build.serial_number") != null) {
      Random r = new Random();
  ...
  static private List getCommandCompilerCPP(String avrBasePath,
    ...
    List baseCommandCompilerCPP = new ArrayList(Arrays.asList(new String[] {
      ...
      "-g", // include debugging info (so errors include line numbers)
      "-Os", // optimize for size
      "-felide-constructors", // optimization used by string class
      "-std=c++0x", // rvalue ref feature used by string class
      "-w", // surpress all warnings
      "-MMD", // output dependancy info
      "-fno-exceptions",
      "-ffunction-sections", // place each function in its own section
